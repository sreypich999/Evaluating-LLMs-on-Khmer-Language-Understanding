...
## 🤖 Models Evaluated
- **Model A (Khmer-Optimized):** Multilingual or regional models (e.g., XLM-RoBERTa, SeaLLM)  
- **Model B (English-Centric):** English-focused base models (e.g., GPT-2, RoBERTa-base)

---

## 🧪 Evaluation Tasks
### 🔹 Part 1: Vocabulary & Tokenizer Analysis
- Script identification using Unicode ranges  
- Vocabulary share by language  
- Token length statistics & histograms  

### 🔹 Part 2: Tokenization Efficiency (Fertility Test)
- Parallel Khmer–English corpus  
- Fertility ratio comparison  
- Boxplot visualization  

### 🔹 Part 3: Embedding Geometry & Semantics
- Static embedding extraction  
- Cosine similarity on translation pairs  
